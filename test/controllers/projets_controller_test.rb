...
class ProjetsControllerTest < ActionController::TestCase
  ...
  test "should create projet" do
    assert_difference('Projet.count') do
      post :create, projet: { creator: @projet.creator, date_rendu: @projet.date_rendu, description: @projet.description, sujet: @projet.sujet }
    end
  ...
  test "should update projet" do
    patch :update, id: @projet, projet: { creator: @projet.creator, date_rendu: @projet.date_rendu, description: @projet.description, sujet: @projet.sujet }
    assert_redirected_to projet_path(assigns(:projet))
  end
